...
var transaction_id = context.getVariable("transaction_id");
...
application_uri = application_uri + "&transaction_id=" + transaction_id;
application_uri = application_uri + "&status=" + status;
