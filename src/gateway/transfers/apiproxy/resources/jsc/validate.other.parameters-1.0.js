...
function validateJWTPayload(parsedPayload) {
    print("entering");
    print("payload" + JSON.stringify(parsedPayload));
    ...
    if (parsedPayload != null) {
        ...
        //     context.setVariable("error_variable", "This value must match the response_type in request parameter");
            ...
            if (jwt.claims.paymentinfo.to.account_number == null || jwt.claims.paymentinfo.to.account_number == "") {
                print('account num = ' + account_number);
                context.setVariable("error_type", "invalid_request");
            ...
            else if (jwt.claims.paymentinfo.to.remote_bic == null || jwt.claims.paymentinfo.to.remote_bic == "") {
                context.setVariable("error_type", "invalid_request");
                context.setVariable("error_variable", "The request is missing a required parameter: remote_bic");
                context.setVariable("status_code", "400");
            }
            else if (jwt.claims.paymentinfo.to.remote_IBAN == null || jwt.claims.paymentinfo.to.remote_IBAN == "") {
                context.setVariable("error_type", "invalid_request");
                context.setVariable("error_variable", "The request is missing a required parameter: remote_IBAN");
                context.setVariable("status_code", "400");
            }
            else {
                print("1 " + jwt.claims.paymentinfo.to);
                print("1 " + jwt.claims.paymentinfo.amount);
                context.setVariable("jwt.claims.paymentinfo.type", jwt.claims.paymentinfo.type);

                context.setVariable("jwt.claims.paymentinfo.to.account_number", jwt.claims.paymentinfo.to.account_number);
                context.setVariable("jwt.claims.paymentinfo.to.remote_bic", jwt.claims.paymentinfo.to.remote_bic);
                context.setVariable("jwt.claims.paymentinfo.to.remote_IBAN", jwt.claims.paymentinfo.to.remote_IBAN);
                context.setVariable("jwt.claims.paymentinfo.to.remote_name", jwt.claims.paymentinfo.to.remote_name);
                ...
                context.setVariable("jwt.claims.paymentinfo.additional.subject", jwt.claims.paymentinfo.additional.subject);
                context.setVariable("jwt.claims.paymentinfo.additional.booking_code", jwt.claims.paymentinfo.additional.booking_code);
                context.setVariable("jwt.claims.paymentinfo.additional.booking_date", jwt.claims.paymentinfo.additional.booking_date);
                context.setVariable("jwt.claims.paymentinfo.additional.value_date", jwt.claims.paymentinfo.additional.value_date);
