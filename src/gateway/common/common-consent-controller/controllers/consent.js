...
//    prepareCustomConsentData:new function (req,res,consentData,cb) {
//    ... custom implementation
//        cb(null,customConsentData)
//    };
//    customDoConsent:new function(req,res,consentData,cb) {
//    .... custom actions
//        cb(null,consentData,true);//true: do default response handling
//    };
//    customRejectConsent:new function(req,res,consentData,cb) {
//    .... custom actions
//        cb(null,consentData,true);//true: do default response handling
//    };
// }
