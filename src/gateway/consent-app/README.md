Consent-app is used for user consent management for client APPs. The consent app  is invoked when a banks's customer wishes to make Account Information API calls
